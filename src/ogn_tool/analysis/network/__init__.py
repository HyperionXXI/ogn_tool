...
from ogn_tool.intelligence.network.station_range_analysis import analyze as analyze_station_range
from ogn_tool.intelligence.network.station_quality_analysis import analyze as analyze_station_quality
